...
//------------------------------------------------------------------------------
// TODOs:
//  - Put the focus on the state radio buttons when keyboard is used.
...
$(function() {
  ...
  if (bDebug) {
    console.log("[%s] Initializing", sModule);
  }

  var selectors = {
    carousel: "._js-carousel",
    viewport: "._js-carousel-viewport",
    slides: "._js-carousel-slides",
    slide: "._js-carousel-slide",
    state: "._js-carousel-state",
    current_state: "._js-carousel-state:checked",
  };

  var attributes = {
    targetid: "data-u-targetid",
  };
  ...
  if (bDebug) { console.log("[%s] [%d] modules found.", sModule, $(selectors.carousel).length); }
  ...
  function initializeScrollPosition() {
    ...
    if (bDebug) {
      console.log("[%s] initializeScrollPosition(): target=[%s] @ offset=[%d]", sModule, current_slide, slide_offset);
    }
  }
  ...
  function updateScrollPosition() {
    ...
    if (bDebug) {
      console.log("[%s] updateScrollPosition()", sModule);
    }
    ...
    if (bDebug) {
      console.log("[%s] updateScrollPosition(): scroll to id=[%s] @ offset=[%d]", sModule, slide_selector, slide_offset);
    }
  ...
  function updateStateVariable() {
    ...
    if (bDebug) {
      console.log("[%s] updateStateVariable()", sModule);
    }
    ...
    if (bDebug) {
      console.log("[%s] updateStateVariable(): viewport scrolled offset=[%d] width=[%d] center=[%d]", sModule, slides_offset, viewport_width, viewport_center);
    }
    ...
    $(selectors.slide).each(function(index, element) {
      ...
      if (bDebug) {
        console.log("[%s] updateStateVariable(): slide#[%d]: offset=[%d] width=[%d] center=[%d] distance=[%d]", sModule, index+1, slide_offset, slide_width, slide_center, slide_distance);
      }
    ...
    if (bDebug) {
      console.log("[%s] updateStateVariable(): closest slide=[%d] state=[%s] distance=[%d]", sModule, closest_slide, closest_state_selector, closest_distance);
    }
